    ...
    <div class="container mx-auto flex items-center justify-between">
        ...
        <div class="hidden md:flex items-center space-x-6" id="nav-links">
            ...
            <div class="relative">
                ...
                <div class="dropdown-content hidden absolute bg-blue-700 text-white py-2 rounded-lg shadow-lg mt-1 w-48">
                    <a href="Job_Details_n" class="block px-4 py-2 hover:bg-blue-600">View Job Details</a>
...
<br>
    ...
    document.querySelector('.relative').addEventListener('mouseover', function() {
